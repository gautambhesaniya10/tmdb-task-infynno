...
const Header = ({setSearchText} :any) => {
  ...
  return (
    <div className="flex items-center justify-between mx-[5%] mt-4">
      ...
      <div className='lg:w-[400px] md:w-[300px] hidden md:block relative'>
        <input type='text' onChange={(e :any) => setSearchText(e.target.value) } placeholder='What do you want to watch ?' className='bg-transparent w-[100%] border-2 border-white rounded-md py-1 px-2 text-white' />
